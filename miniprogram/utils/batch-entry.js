...
function buildBatchListItem(material, uniqueCode, defaults = {}) {
  ...
  return {
    ...
    material_name: defaults.material_name || material.material_name,
    product_code: material.product_code,
    category: material.category,
    subcategory_key: defaults.subcategory_key || material.subcategory_key || '',
    sub_category: defaults.sub_category || material.sub_category,
